      ...
      <div className='max-w-[1000px] py-40 px-10 md:px-20 flex justify-center items-center bg-slate-900'>
        <div className=' leading-8 uppercase'>
          <div className='mb-6'>
            ...
            exhibition at the gallery, titled MORE ABSTRACT, from April 26 to
            June 24, 2023. The show features 50 works from five series created
            between 2008 and 2023, exploring chemical, optical, and economic
            phenomena.
          </div>
          <div className='mb-6'>
            ...
            , alongside with a large-format print of one of these originals. The
            second floor is dedicated to geometric abstractions, including the
            interactive work{' '}
          ...
          <div className='mb-6'>
            ...
            critical essay highlights Pedro's financial abstractionism practiced
